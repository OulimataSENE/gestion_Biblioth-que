...
public class Test extends BibliothequeGUI {
    public void main(String[] args) throws LibraryException {
        ...
        Livre livre1 = new Livre("Une si longue lettre", "Mariama Ba", 1997, "9780545010221");
        Livre livre2 = new Livre("De purs hommes", "Mohames Mbougar Sarr", 1954, "9782070612880");

        Utilisateur utilisateur1 = new Utilisateur("Fama", 1001, 3, 0, 222);
